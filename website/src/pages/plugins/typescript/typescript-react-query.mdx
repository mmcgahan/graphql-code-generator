...
export const getStaticProps = getNpmInfo('typescript-react-query')
...
<Callout>
  Note: all generated hooks are just wrappers around `@tanstack/react-query` original functions. This codegen plugin just burns
